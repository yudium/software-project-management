...
@section('title', 'Proyek Sukses: Daftar berdasarkan Tag')
...
@section('content')
    <div class="container">
        @component('pagetitle')
            Daftar Proyek Sukses Berdasarkan Tag
        @endcomponent

        <form action="{{ route('success-project-by-tags-list') }}" method="get">
...
@if ($query_tags)
    ...
    require(['datatables', 'jquery'], function(datatable, $) {
        $('.datatable').DataTable({
            ...
            pageLength: 3,
            ajax: '{{ route('success-project-by-tags-list-ajax', ['tags' => $query_tags]) }}',
