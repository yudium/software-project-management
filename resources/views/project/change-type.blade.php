...
<div class="container">
    ...
    <div class="row row-cards">
        <div class="col col-3 mx-auto">
            <a id="next_button" href="{{ url('project/change-type/confirmation') . '/' . $project->id}}" class="btn btn-primary disabled">Berikutnya</a>
        </div>
    </div>
</div>
@endsection
    ...
    require(['jquery'], function($) {
        $(document).ready(function(){
            ...
            $(".check-circle-container a").click(function(e){
                ...
                $("#next_button").attr('href', $("#next_button").attr('href') + '/' + project_type_id);
