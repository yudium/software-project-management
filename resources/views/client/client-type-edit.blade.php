...
<div class="container">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                        <tbody>
                            ...
                            <tr>
                                <td width="10%" class="text-center"><i class="{{ $client_type->icon }} text-muted"></i></td>
                                <td width="80%">{{ $client_type->name }}</td>
                                <td width="10%" class="text-center">
                                    <span class="check-circle-container">
                                        <a href="#" data-client-type-id="{{ $client_type->id }}" class="btn btn-outline-info btn-sm">Pilih</a>
    ...
    <div class="row row-cards">
        <div class="col col-3 mx-auto">
            <a id="next_button" href="{{ url('client/client-type-update') . '/' . $client->id}}" class="btn btn-primary disabled">Berikutnya</a>
        </div>
    </div>
</div>
@endsection
    ...
    require(['jquery'], function($) {
        $(document).ready(function(){
            ...
            $(".check-circle-container a").click(function(e){
                ...
                $("#next_button").attr('href', $("#next_button").attr('href') + '/' + client_type_id);
