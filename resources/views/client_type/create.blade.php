...
@section('title', 'Tambah Tipe Client: Form Utama')

@section('content')
    <div class="container">

        <form style="width: 350px" class="card mx-auto" action="{{ route('store-client-type') }}" method="post">
            @csrf

            <div class="card-body">
                <div class="card-title">Buat Tipe Client Baru</div>
